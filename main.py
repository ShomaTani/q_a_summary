...
def classify_and_summarize(test, num, pdf_file_obj=None):
    prompt = f"""
...
def load_pdf(lecture_pdf):
    ...
    if lecture_pdf is not None:
        ...
        pdf_file_obj = client.files.upload(file="temp_lecture.pdf", mime_type="application/pdf")
    return pdf_file_obj
# record = fetch_sheet("https://docs.google.com/spreadsheets/d/1gUXLRZQjD4M9a5w9m256CRtMAbyWNdr8psfOl_rplIs/edit?gid=1929216301#gid=1929216301")
